...
import { peopleOutline, personAddOutline, gridOutline, qrCodeOutline, cashOutline, logOutOutline, layersOutline } from 'ionicons/icons';
...
export class SupervisorPage implements OnInit {
  ...
  constructor() {
    addIcons({ peopleOutline, personAddOutline, gridOutline, qrCodeOutline, cashOutline, logOutOutline, layersOutline });
